...
async function add_broker() {
    ...
    await driver.findElement(By.name('firstName')).sendKeys('Pro');
    await driver.sleep(2000);
    await driver.findElement(By.name('lastName')).sendKeys('Test');
    await driver.sleep(2000);
    await driver.findElement(By.name('email')).sendKeys('protest@mailinator.com');
    await driver.sleep(2000);
    ...
    plan = await driver.findElement(By.xpath('//*[@id="content"]/div[3]/section/div[2]/article/div/div[2]/div/form/fieldset/div[2]/div[2]/div[1]/div[1]/div[1]/div/select/option[2]'));
    plan.click();
    await driver.sleep(2000);
    await driver.findElement(By.name('loanOfficer.numberOfSeats')).clear()
    await driver.sleep(3000);
    await driver.findElement(By.name('loanOfficer.numberOfSeats')).sendKeys("2");
    await driver.sleep(3000);
    await driver.findElement(By.name('support.numberOfSeats')).clear()
    await driver.sleep(3000);
    await driver.findElement(By.name('support.numberOfSeats')).sendKeys("2");
